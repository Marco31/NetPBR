...
def set_ACL_test():
    ...
    npr.set_ACL(sdw1_connect, 102, npr.links[0][0], "0.0.0.255", npr.links[0][1], "0.0.0.255")
    ...
    npr.set_ACL(sdw1_connect, 102, npr.links[0][0], "0.0.0.255", npr.links[1][1], "0.0.0.255")
    npr.unset_ACL(sdw1_connect, 102)
    cmd = "traceroute " + npr.links[0][1]
    cisco_output = list((sdw1_connect.send_command(cmd, read_timeout=75)).split('\n'))
    print(cisco_output)
